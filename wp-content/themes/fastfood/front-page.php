<?php get_header(); ?>
    ...
    <section class="categories">
        <div class="container">
            <h2 class="text-center"><?php the_field('categories_title'); ?></h2>
            <?php

            if( have_rows('foodmenu') ):
                $count = 0;

                while( have_rows('foodmenu') ) : the_row();
                    $count +=1;
                    ...
                    <div class="box-3 float-container">
                        <img src="<?php echo esc_url($category_image['url']); ?>" alt="<?php echo esc_attr($image['alt']); ?>" class="img-responsive img-curve">
    ...
    <section class="food-menu">
        ...
        <p class="text-center">
            <a href="/all-foods">See All Foods</a>
        </p>
    </section>
